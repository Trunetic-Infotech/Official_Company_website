    ...
    <div className="w-full px-4 md:px-16 py-16 bg-gray-50">
      ...
      <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
        ...
        <div className="w-full md:w-1/2 text-gray-700 leading-relaxed text-lg">
          ...
          <p className="mb-4">
            Our internship program offers students and freshers the opportunity 
            to gain practical experience in different domains of software development. 
            We provide a structured learning path with real projects in App, Backend, 
          ...
          <p>
            ...
            <span className="font-semibold"> Join us and kickstart your career!</span>
          </p>
        </div>
      </div>
          ...
          {benefits.map((item, index) => (
            ...
            >
              ...
              <p className="text-gray-600">
                Gain practical knowledge and industry experience while working on live projects.
              </p>
            </div>
          ))}
        </div>
