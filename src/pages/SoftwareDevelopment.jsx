...
import Web from "../assets/ServicessType/software.webp"; 
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 mb-16">
          ...
          <div className="w-full md:w-1/2 text-gray-700 leading-relaxed text-lg">
            ...
            <p className="mb-4">
              ...
              , we provide custom software solutions that help businesses
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-blue-50 hover:bg-blue-100 transition-all p-6 rounded-xl shadow-md border border-blue-200">
              ...
              <p className="text-gray-600">
                We craft fully tailored software that aligns with your workflows and improves operational efficiency.
              </p>
            </div>
            ...
            <div className="bg-blue-50 hover:bg-blue-100 transition-all p-6 rounded-xl shadow-md border border-blue-200">
              ...
              <p className="text-gray-600">
                Our applications are optimized for speed, performance, and future scalability as your business grows.
              </p>
            </div>
            ...
            <div className="bg-blue-50 hover:bg-blue-100 transition-all p-6 rounded-xl shadow-md border border-blue-200">
              ...
              <p className="text-gray-600">
                Software built to run smoothly across platforms and ready for cloud deployment for better flexibility.
              </p>
            </div>
            ...
            <div className="bg-blue-50 hover:bg-blue-100 transition-all p-6 rounded-xl shadow-md border border-blue-200">
              ...
              <p className="text-gray-600">
                Strong data encryption, secure authentication, and advanced protection measures ensure complete safety.
              </p>
            </div>
            ...
            <div className="bg-blue-50 hover:bg-blue-100 transition-all p-6 rounded-xl shadow-md border border-blue-200">
              ...
              <p className="text-gray-600">
                We design modern interfaces that elevate user experience and simplify daily operations.
              </p>
            </div>
            ...
            <div className="bg-blue-50 hover:bg-blue-100 transition-all p-6 rounded-xl shadow-md border border-blue-200">
              ...
              <p className="text-gray-600">
                Our support team keeps your software updated, secure, and running smoothly at all times.
              </p>
            </div>
